...
const Form: React.FC<FormProps> = (props) => {
  ...
  let submitButton = <button onClick={props.onSubmit} disabled={!isInputValid2} className="mt-8 bg-gradient-to-r from-sky-500 to-sky-800 text-white text-lg p-2 w-full rounded-md disabled:opacity-50 disabled:bg-gray-500">Submit</button>
  if (props.isLoading) {
    submitButton =  <button type="button" disabled={props.isLoading}  className="mt-8 text-white text-lg p-2 w-full rounded-md bg-slate-900">
